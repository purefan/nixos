...

{
  ...
  # 19/06/2023 try to change default grub option
...
#      nodejs_18
  ...
  fileSystems."/newbehe" = {
    ...
    options = [
      "rw"
      "users"
      # disabling as suggested by https://www.reddit.com/r/NixOS/comments/1497xi3/comment/jocq9z5/?utm_source=share&utm_medium=web2x&context=3
